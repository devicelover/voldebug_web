	...
	<div class="project pt-100 pb-100">
		<div class="container">
			<div class="row">
							...
							<div class="project__meta">
								<div class="project__meta--info">
									<span class="project-name"><a href="portfolio-details.html">E-learnig
											Website</a></span>
									<span class="project-by">Team Work</span>
								</div>
								<div class="project__meta--link">
									<a href="portfolio-details.html" class="link-btn"><i
							...
							<div class="project__meta">
								<div class="project__meta--info">
									<span class="project-name"><a href="portfolio-details.html">Travel App
											Design</a></span>
									<span class="project-by">Shanto Sharif</span>
								</div>
								<div class="project__meta--link">
									<a href="portfolio-details.html" class="link-btn"><i
											class="fa-sharp fa-light fa-arrow-right-long"></i></a>
				...
				<div class="block-elements pt-20">
					<a href="#" data-toggle="modal" class="btn ajax-btn" data-target="#ajax-modal">
						Load More <span><i class="fa-light fa-gear"></i></span>
					</a>
				</div>
			</div>
		</div>
