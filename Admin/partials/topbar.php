    ...
    <div class="navbar-header">
        <div class="d-flex">
            ...
            <div class="navbar-brand-box text-center">
                <a href="index.php" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="./assets/images/2.png" alt="logo-sm-dark" height="200">
                    </span>
                    <span class="logo-lg">
                        <img src="./assets/images/2.png" alt="logo-dark" height="200">
                    </span>
                </a>

                <a href="index.php" class="logo logo-light">
                    <span class="logo-sm">
                        <img src="./assets/images/2.png" alt="logo-sm-light" height="200">
                    </span>
                    <span class="logo-lg">
                        <img src="./assets/images/2.png" alt="logo-light" height="200">
                    </span>
                </a>
            </div>
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
                ...
                <i class="mdi mdi-bell notification-icon"></i>
                </button>
            </div>
