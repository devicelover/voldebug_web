...
<head>
    <?php includeFileWithVariables('partials/title-meta.php', array('Voldebug' => 'Blog')); ?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="modal-header">
                            <h1 class="modal-title fs-5 p-3" id="exampleModalLabel">Add Details About Blog</h1>
                        </div>
...
<?php echo csrf_field(); ?>
                            <div class="modal-body p-4">
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="form-group">
                                        ...
                                        <textarea name="longdescription" class="form-control"
                                            placeholder="Enter Long Description" id="blogarea"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="form-group">
                                        <label for="time">Blog Post Date</label>
                                        <input type="date" name="time" class="form-control" placeholder="Date"
                                            required>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12 mb-3">
                                    <label for="image">Blog Main image</label>
                                    <input type="file" name="image" accept="image/*" class="form-control" required>
                                </div>
                            </div>

                            <div class="modal-footer">
                                <button type="submit" name="add_blog" class="btn btn-primary">Upload</button>
                            </div>
                        </form>
                    </div> <!-- row -->
