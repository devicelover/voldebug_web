...
<?php
	...
	<!-- project details -->
	<div class="project-details pt-100 pb-100">
		<div class="container">
			<div class="row">
				<div class="col-12">
					<div class="project-details__wrapper">
						<div class="project-details__info">
							<ul>
								<li>
									<div class="d-flex item"><span>Client:</span> <span class="content">Jenifer
											Jara</span></div>
								</li>
								<li>
								...
								<li>
									<div class="d-flex item"><span>Category:</span> <span class="content">Web
											Design</span></div>
								</li>
								<li>
									<div class="d-flex item"><span>Project Link:</span> <span class="content"><a
												href="#">Voldebug</a></span></div>
								</li>
								<li>
									<div class="d-flex item"><span>Delivered:</span> <span class="content">July 01,
											2023</span></div>
								</li>
							</ul>
						</div>
