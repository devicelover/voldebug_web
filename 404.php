				...
				<div class="col-lg-12">
					<div class="error__wrapper">
						<div class="error__icon--animate">
							<img src="assets/img/icon/cloud.svg" alt="error">
							<img src="assets/img/icon/ball.svg" alt="error">
							<img src="assets/img/icon/ball.svg" alt="error">
							<img src="assets/img/icon/four-round-start.svg" alt="error">
							<img src="assets/img/icon/four-round-start.svg" alt="error">
							<img src="assets/img/icon/all-star.svg" alt="error">
